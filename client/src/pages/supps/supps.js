    ...
    return (
      <div>
        ...
        <div>
         ...
         <div className="col-md-3">
         <div class="card" >
                <img id="omlette" class="card-img-top" src="https://s3.images-iherb.com/ndm/ndm01328/l/5.jpg" alt="Card image cap"></img>
                <div id="CB" class="card-body text-white">
         ...
         <div className="col-md-3">
         <div class="card" >
                <img id="omlette" class="card-img-top" src="https://s3.images-iherb.com/sre/sre01027/l/3.jpg" alt="Card image cap"></img>
                <div id="CB" class="card-body text-white">
      ...
      <div id="oats" className="row">
          <div className="col-md-3">
          <div class="card" >
                <img id="omlette" class="card-img-top" src="https://target.scene7.com/is/image/Target/10994233?wid=488&hei=488&fmt=pjpeg" alt="Card image cap"></img>
                <div id="CB" class="card-body text-white">
                    <h5 className="foodT">Multi-Vitamin</h5>
                    <p className="foodP" >Excellent source of dietary vitamins if you are deficient.</p>
                </div>
                </div>
         ...
         <div className="col-md-3">
         <div class="card" >
                <img id="omlette" class="card-img-top" src="https://target.scene7.com/is/image/Target/14161828?wid=488&hei=488&fmt=pjpeg" alt="Card image cap"></img>
                <div id="CB" class="card-body text-white">
         ...
         <div className="col-md-3">
         <div class="card" >
                <img id="omlette" class="card-img-top" src="https://images-na.ssl-images-amazon.com/images/I/61oHhFmlJ6L._SY355_.jpg" alt="Card image cap"></img>
                <div id="CB" class="card-body text-white">
                    <h5 className="foodT">5-HTP </h5>
                    <p className="foodP" >Helps with relaxation and mood. Creates better sleep patterns.</p>
                </div>
                </div>
