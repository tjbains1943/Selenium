    ...
    return (
      <div>
        ...
        <div>
         ...
         <div class="card" >
                ...
                <div id="CB" class="card-body">
                    <h5 className="foodT">Breakfast</h5>
                    <p className="foodP" >Instead of pancakes, try out an protien shake instead.</p>
                </div>
                </div>
      ...
      <div id="oats" className="row">
         ...
         <div class="card" >
                ...
                <div id="CB" class="card-body">
                    <h5 className="foodT">Dinner</h5>
                    <p className="foodP" >Instead of always eating out for dinner, grill up a steak and veggies!</p>
                </div>
                </div>
