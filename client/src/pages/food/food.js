    ...
    return (
      <div className="HRs">
        ...
        <div>
          ...
          <div className="card" >
                <img id="omlette" className="card-img-top" src="https://imagesvc.timeincapp.com/v3/mm/image?url=http%3A%2F%2Fimg1.cookinglight.timeinc.net%2Fsites%2Fdefault%2Ffiles%2Fstyles%2Fmedium_2x%2Fpublic%2F1515527235%2F1801w-steel-cut-oats-recipe.jpg%3Fitok%3DaLUShBxU&w=700&q=85" alt="Card cap"></img>
                <div id="CB" className="card-body text-white">
            ...
            <div className="col-md-4">
            <div className="card" >
                <img id="omlette" className="card-img-top" src="https://images.meredith.com/content/dam/bhg/Images/2014/10/15/RU234616.jpg.rendition.largest.jpg" alt="Card cap"></img>
                <div id="CB" className="card-body text-white">
                    <h5 className="foodT">Breakfast</h5>
         ...
         <div className="col-md-4">
         <div className="card" >
                <img id="omlette" className="card-img-top" src="https://img.buzzfeed.com/thumbnailer-prod-us-east-1/dd3ea4e4a8dd42ec97db43d518431bd6/BFV21177_ProteinSmoothies5Ways-FB1080SQ.jpg?output-quality=60&resize=1000:*" alt="Card cap"></img>
                <div id="CB" className="card-body text-white">
                    <h5 className="foodT">Breakfast</h5>
      ...
      <div id="oats" className="row">
          <div className="col-md-4">
          <div className="card" >
                <img id="omlette" className="card-img-top" src="http://img1.cookinglight.timeinc.net/sites/default/files/styles/4_3_horizontal_-_1200x900/public/image/2017/10/main/cl_digi_58.jpg?itok=C2WHk01D" alt="Card cap"></img>
                <div id="CB" className="card-body text-white">
            ...
            <div className="col-md-4">
            <div className="card" >
                <img id="omlette" className="card-img-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcXrMyMa_JW7lNlTRHpP4dYWxnWM2-GBdz5EgmPqeb3FBsXrUf" alt="Card cap"></img>
                <div id="CB" className="card-body text-white">
                    <h5 className="foodT">Lunch</h5>
      ...
      <div id="oats" className="row">
          <div className="col-md-4">
          <div class="card" >
                <img id="omlette" className="card-img-top" src="http://www.adorndanceandart.com/uploads/5/2/9/6/52966941/s197082391318440730_p16_i5_w525.jpeg" alt="Card cap"></img>
                <div id="CB" className="card-body text-white">
            ...
            <div className="col-md-4">
            <div className="card" >
                <img id="omlette" className="card-img-top" src="http://www.simplyscratch.com/wp-content/uploads/2016/02/DSC32072-620x414.jpg" alt="Card cap"></img>
                <div id="CB" className="card-body text-white">
                    <h5 className="foodT">Dinner</h5>
         ...
         <div className="col-md-4">
         <div className="card" >
                <img id="omlette" className="card-img-top" src="http://images.meredith.com/dlv/images/recipe/ss_R149539.jpg" alt="Card cap"></img>
                <div id="CB" className="card-body text-white">
                    <h5 className="foodT">Dinner</h5>
